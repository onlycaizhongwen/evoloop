...
## 2026-06-01 Localized Home Run Statuses
...
- Visual check: local Chrome headless screenshot `.tmp/task-manager-8767.png` showed the task manager title, filters, batch operation dropdown, checkbox column, task table, and row actions rendered together without obvious overlap.
